...
uint8_t aRxBuffer[TXBUFFERSIZE];
...
/* Configure the peripherals common clocks */
  ...
  /*## Configure the UART Emulation  ######################################*/
  /* UART Emulation configured as follow:
        - Word Length = 8 Bits (include parity bit if applicable)
  ...
  UartEmulHandle.Init.Parity      = UART_EMUL_PARITY_ODD;
  UartEmulHandle.Init.WordLength  = UART_EMUL_WORDLENGTH_9B;
  ...
  if (HAL_UART_Emul_Receive_DMA(&UartEmulHandle, (uint8_t *)aRxBuffer, 12) != HAL_OK)
  {
	Error_Handler();
  }

  HAL_Delay(1000);
  strcpy((char*)aTxBuffer, "Hello World!");
  if(HAL_UART_Emul_Transmit_DMA(&UartEmulHandle, (uint8_t *)aTxBuffer, 12) != HAL_OK)
  {
	  Error_Handler();
  }
  ...
  if(memcmp(aRxBuffer, aTxBuffer, 12) == 0)
	  testSuccess = 1;
